...
| H1.5 | Support make/model merge and archive while preserving fitment and audit history | partial | Make/model archive + atomic merge are live-verified with stable descendant ids, aliases/cache/audit and guarded delete. FR-112/AC-012 also require generation merge with duplicate-configuration/claim reassignment; that remaining workflow is not yet implemented |
