...
- **H1.6a top-10 brands besides BMW** is the active vehicle/VIN workstream (plugin 0.100.0 slice 5:
  more NHTSA-documented flagships, 143 non-BMW VDS prefixes). Later slices still add provenanced
  VDS the same way — add JSON, never manufacturer literals in Domain, never fabricate VDS maps.
