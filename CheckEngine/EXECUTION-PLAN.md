...
| H2.4 | Implement vector/semantic bilingual search | partial | SQL catalog + embedding index; scheduled refresh with empty-index bootstrap; admin-managed bilingual synonym overrides; index-time + query-time expansion; model-hash staleness |
