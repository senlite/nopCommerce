...
- **H1.6a top-10 brands besides BMW** is the active vehicle/VIN workstream (plugin 0.98.0 slice 3:
  more NHTSA flagships, golden check-digit VIN corpus, application-layer decode). Expand catalogs
