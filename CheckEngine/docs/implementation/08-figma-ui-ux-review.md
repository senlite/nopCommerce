...
**Date:** 2026-09-02 · **Plugin at review:** `TwinParticles.CheckEngine` `0.91.0` · **Implementation:** `0.92.0` UX.1–UX.8; `0.93.0` theme shell; `0.94.0` category/PDP/cart templates · **Host theme:** DefaultClean structure under a Check Engine dark shell
...
5. Partial (UX.9, plugin `0.94.0`) — dark shell, wordmark, home without host lorem, plus category/search/PDP/cart templates and fitment in the buy box. Remaining: self-hosted font files and Lighthouse CWV evidence vs [21].
