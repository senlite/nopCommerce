...
using TwinParticles.CheckEngine.Infrastructure.Workshop;
using TwinParticles.CheckEngine.Infrastructure.Fleet;
using TwinParticles.CheckEngine.Infrastructure.Dealer;
using TwinParticles.CheckEngine.Infrastructure.Portals;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddCheckEngineInfrastructure(this IServiceCollection services)
    {
        ...
        services.AddScoped<IPayoutStatementRepository, SqlPayoutStatementRepository>();
        services.AddScoped<IPayoutStatementDataSource, SqlPayoutStatementDataSource>();
        services.AddScoped<IOrderVendorSplitStore, SqlOrderVendorSplitStore>();
        services.AddScoped<IWorkshopJobRepository, SqlWorkshopJobRepository>();
