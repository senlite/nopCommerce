...
public sealed class CheckEnginePlugin : BasePlugin, IMiscPlugin, IWidgetPlugin
{
    ...
    private async Task AddOrUpdateLocaleResourcesAsync()
    {
        var englishResources = new Dictionary<string, string>
        {
            ...
            ["Plugins.TwinParticles.CheckEngine.Image.Admin.Template.Hint"] = "One SKU per line. URLs come from the configured supplier image template ({sku}).",
    ...
    private static Dictionary<string, string> ArabicResources() => new()
    {
        ...
        ["Plugins.TwinParticles.CheckEngine.Image.Admin.Template.Hint"] = "SKU واحد في كل سطر. تُبنى الروابط من قالب صور المورد ({sku}).",
